...
import createFabric from '../controllers/configFragments/createFabric.js';
import createColour from '../controllers/configFragments/createColour.js';
...
router.post('/config_fabrics', createFabric); // *** get all
router.post('/config_colours', createColour); // *** get all
